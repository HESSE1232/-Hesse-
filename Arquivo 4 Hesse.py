...
botao_potencia.grid(column=1, row=6)
botao_raiz = tk.Button(janela, text="√", command=lambda: inserir_texto("sqrt("), width=13, height=4, font=("Arial", 12))
botao_raiz.grid(column=2, row=6)
botao_fracao = tk.Button(janela, text="1/x", command=lambda: inserir_texto("1/"), width=13, height=4, font=("Arial", 12))
botao_fracao.grid(column=3, row=6)
botao_igual=tk.Button(janela, text="=",command=lambda:avaliar(),width=13, height=4,font=("Arial",12))
botao_igual.grid(column=4,row=6)
botao_C=tk.Button(janela, text="C",command=lambda:apagar(),width=13, height=4,font=("Arial",12))
botao_C.grid(column=4,row=7,columnspan=4)
